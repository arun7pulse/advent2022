...
public class ElfD10SignalStrengthPart1 {
    ...
    public static void main(String arg[]) {
        ...
        List<String> dataList = elf.readFile("10.txt");
    ...
    private void findSignalStrength(List<String> dataList) {
        ...
        for (String data : dataList) {
            ...
            if (operator.equals("noop")) {
                // System.out.println("Current Cmd is noop and before / that tiem x Value is " +
                // X +" and the no of cycles before "+noOfCycles);

                noOfCycles++;
                // System.out.println("Result ::: \nnoOfCycles is " + noOfCycles + "\nX value is
                // " + X);
                // System.out.println("Current Cmd is noop and After that tiem x Value is " +
                // X);
            ...
            // System.out.println("Current Cmd is addx and V value is " + V + " that tiem x
            // Value is " + X +" and the no of cycles before "+noOfCycles);
            noOfCycles += 1;

            // System.out.println("Result ::: \nnoOfCycles is " + noOfCycles + "\nX value is
            // " + X);
            // System.out.println("Current Cmd is addx and V value is " + V + " After that
            // tiem x Value is " + X);
            //
